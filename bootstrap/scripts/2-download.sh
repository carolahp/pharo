...
${BOOTSTRAP_REPOSITORY}/bootstrap/scripts/getPharoVM.sh 80 vm 64
#wget --progress=dot:mega https://github.com/carolahp/PharoBootstrap/releases/download/v2.0.2/bootstrapper.zip
cp ~/Downloads/bootstrapper.zip ./bootstrapper.zip
unzip bootstrapper.zip
